...
namespace SE.Engine.Networking.Internal
{
    ...
    internal static class DelegateFactory
    {
        ...
        /// <param name="obj">Object the method is invoked on.</param>
        /// <returns></returns>
        public static LateBoundMethod Create(MethodInfo method, object obj = null)
        {
        ...
        {
            return method.GetParameters().Select((parameter, index) => Expression.Convert(
