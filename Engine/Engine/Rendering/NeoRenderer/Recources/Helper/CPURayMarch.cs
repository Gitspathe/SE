...
namespace DeferredEngine.Recources.Helper
{
    public class CPURayMarch
    {
        ...
        public void Calculate(RenderTarget2D depthMap, RenderTarget2D normalMap, Matrix Projection,
            Matrix inverseViewMatrix, Matrix inverseViewProjection, Camera2D camera, Vector3[] currentCorners)
        {
        ...
        //samplePositions.Clear();
        //sampleTests.Clear();
        public void CalculateOld(RenderTarget2D depthMap, RenderTarget2D normalMap, Matrix InverseViewProjection, Matrix viewProjection, Camera2D camera, Vector3[] currentCorners)
        {
