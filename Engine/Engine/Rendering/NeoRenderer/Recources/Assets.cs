...
namespace DeferredEngine.Recources
{
    public class Assets : IDisposable
    {
        ...
        public void Load(ContentManager content, GraphicsDevice graphicsDevice)
        {
            ...
            SponzaModel = new ModelDefinition(content.Load<Model>("Sponza/Sponza"), new SE.Common.Transform(new System.Numerics.Vector3(0,0,0), new System.Numerics.Vector3(1,1,1)));
