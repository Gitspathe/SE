...
namespace DeferredEngine.Renderer.RenderModules
{
    public class ForwardRenderModule : IRenderModule, IDisposable
    {
        ...
        /// <returns></returns>
        public RenderTarget2D Draw(GraphicsDevice graphicsDevice, RenderTarget2D output, MeshMaterialLibrary meshMat, Matrix viewProjection, Camera2D camera, List<PointLight> pointLights, BoundingFrustum frustum)
        {
        ...
        private void SetupLighting(Camera2D camera, List<PointLight> pointLights, BoundingFrustum frustum)
        {
            //Setup camera
