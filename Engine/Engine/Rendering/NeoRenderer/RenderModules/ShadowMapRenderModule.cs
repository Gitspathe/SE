...
using IRenderModule = DeferredEngine.Renderer.RenderModules.Default.IRenderModule;
...
namespace DeferredEngine.Renderer.RenderModules
{
    public class ShadowMapRenderModule : IRenderModule
    {
        ...
        public void Draw(GraphicsDevice graphicsDevice, MeshMaterialLibrary meshMaterialLibrary, List<ModelRenderer> entities, List<PointLight> pointLights, List<DirectionalLight> dirLights, Camera2D camera)
        {
        ...
        private void CreateShadowCubeMap(GraphicsDevice graphicsDevice, PointLight light, int size, MeshMaterialLibrary meshMaterialLibrary, List<ModelRenderer> entities)
        {
        ...
        /// <param name="meshMaterialLibrary"></param>
        /// <param name="entities"></param>
        private void CreateShadowMapDirectionalLight(GraphicsDevice graphicsDevice, DirectionalLight light, int shadowResolution, MeshMaterialLibrary meshMaterialLibrary, List<ModelRenderer> entities)
        {
