...
using PointLight = DeferredEngine.Entities.PointLight;
using FullScreenTriangle = DeferredEngine.Renderer.Helper.FullScreenTriangle;
using GameSettings = DeferredEngine.Recources.GameSettings;
using GameStats = DeferredEngine.Recources.GameStats;
using Shaders = DeferredEngine.Recources.Shaders;
...
namespace DeferredEngine.Renderer
{
    public class Renderer : IDisposable
    {
        ...
        public void Update(GameTime gameTime, bool isActive, List<ModelRenderer> entities)
        {
            if (!isActive) return;
        ...
        /// <param name="gameTime"></param>
        /// <returns></returns>
        public void Draw(Camera2D camera, MeshMaterialLibrary meshMaterialLibrary, List<ModelRenderer> entities, List<PointLight> pointLights, List<DirectionalLight> directionalLights, EnvironmentSample envSample, GameTime gameTime)
        {
        ...
        private void DrawCubeMap(Vector3 origin, MeshMaterialLibrary meshMaterialLibrary, List<ModelRenderer> entities, List<PointLight> pointLights, List<DirectionalLight> dirLights, EnvironmentSample envSample, float farPlane, GameTime gameTime, Camera2D camera)
        {
        ...
        private void CheckRenderChanges(List<DirectionalLight> dirLights)
        {
            ...
            if (_forceShadowFiltering != GameSettings.g_shadowforcefiltering)
            {
                ...
                {
                    Entities.DirectionalLight light = dirLights[index];
        ...
        /// <param name="dirLights"></param>
        /// <param name="camera"></param>
        private void DrawShadowMaps(MeshMaterialLibrary meshMaterialLibrary, List<ModelRenderer> entities, List<Entities.PointLight> pointLights, List<Entities.DirectionalLight> dirLights, Camera2D camera)
        {
        ...
        /// <param name="meshMaterialLibrary"></param>
        /// <param name="entities"></param>
        private void UpdateViewProjection(Camera2D camera, MeshMaterialLibrary meshMaterialLibrary, List<ModelRenderer> entities)
        {
        ...
        private void ComputeFrustumCorners(BoundingFrustum cameraFrustum, Camera2D camera)
        {
        ...
        /// </summary>
        /// <param name="camera"></param>
        private void DrawScreenSpaceAmbientOcclusion(Camera2D camera)
        {
        ...
        /// <param name="gameTime"></param>
        private void DrawEmissiveEffect(Camera2D camera, MeshMaterialLibrary meshMatLib, GameTime gameTime)
        {
        ...
        private RenderTarget2D DrawForward(RenderTarget2D input, MeshMaterialLibrary meshMaterialLibrary, Camera2D camera, List<PointLight> pointLights)
        {
        ...
        private void DrawSignedDistanceFieldFunctions(Camera2D camera)
        {
        ...
        private void CpuRayMarch(Camera2D camera)
        {
