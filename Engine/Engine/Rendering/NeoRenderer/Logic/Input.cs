...
namespace DeferredEngine.Logic
{
    public static class Input
    {
        ...
        public static void Update(GameTime gameTime, Camera2D camera)
        {
        ...
        private static void MouseEvents(Camera2D camera)
        {
        ...
        private static void KeyboardEvents(GameTime gameTime, Camera2D camera)
        {
            ...
            {
                //camera.Transform.Position += direction * amount;
            }
            ...
            {
                //camera.Transform.Position += normal * amountNormal;
            }
